export const proposedAbi = [
  ...
  "function registerProduct(bytes32 productId, bytes32 certificateHash, string name, string batchNumber, uint32 manufacturedAt, uint32 expiryAt) external",
  ...
  "function getProductSummary(bytes32 productId) external view returns (string name, string batchNumber, uint8 stage, uint8 validationStatus, address currentCustodian, uint8 approvalCount, uint8 rejectionCount, bytes32 certificateHash, uint32 manufacturedAt, uint32 expiryAt)",
  "function getProduct(bytes32 productId) external view returns (string name, string batchNumber, bytes32 certificateHash, address currentCustodian, uint32 createdAt, uint32 updatedAt, uint32 manufacturedAt, uint32 expiryAt, uint8 stage, uint8 validationStatus, uint8 approvalCount, uint8 rejectionCount)",
