export const proposedAbi = [
  ...
  "function getProduct(bytes32 productId) external view returns (bytes32 certificateHash, address currentCustodian, uint32 createdAt, uint32 updatedAt, uint8 stage, uint8 validationStatus, uint8 approvalCount, uint8 rejectionCount)",
